...
function true_options() {
	global $true_page;
	add_options_page( 'Site options', 'Основные настройки сайта', 'manage_options', $true_page, 'true_option_page');
}
...
function true_option_settings() {
	...
	add_settings_field( 'my_text_field', 'Укажите номер телефона', 'true_option_display_settings', $true_page, 'true_section_1', $true_field_params );
